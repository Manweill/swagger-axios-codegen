...
export class DeviceBoardService {
   ...
   * @throws {RequiredError}
   */
  static uploadDeviceBoard(
    parameters: { file?: any | null[] },
    options: IRequestOptions = {}
...
export class TicketTaskService {
   ...
   * @throws {RequiredError}
   */
  static confirmTicket(
    parameters: { input?: ConfirmTicketInput },
    options: IRequestOptions = {}
  ): AxiosPromise<ApiResultOutput> {
    const configs = <AxiosRequestConfig>{ ...options };
    configs.headers['Content-Type'] = 'application/json';
...
export class LockControlTaskDto {
  ...
  /**
   *
   * @type {'None'|'WaitCommit'|'WaitConfirm'|'ConfirmNotPassed'|'WaitGuardianConfirm'|'WaitApproverConfirm'|'WaitMainApproverConfirm'|'WaitApprove'|'ApproveNotPassed'|'ReadyGo'|'Executing'|'Pause'|'WaitApproveToCancel'|'WaitApproveToBreak'|'WaitApproveExtension'|'ExtensionReject'|'Finished'|'Break'|'Cancel'|'WaitReadOver'|'ReadOver'|'Archived'}
   * @memberof LockControlTaskDto
   */
  state:
    | 'None'
...
export class TicketOperatePropertyDto {
   ...
   * @memberof TicketOperatePropertyDto
   */
  canConfirmByMainApprover: boolean;
  ...
  constructor(data?: any) {
    if (data) {
      ...
      this['canConfirmByGuardian'] = data['canConfirmByGuardian'];
      this['canConfirmByMainApprover'] = data['canConfirmByMainApprover'];
      this['canConfirmByApprover'] = data['canConfirmByApprover'];
    }
  }
}
